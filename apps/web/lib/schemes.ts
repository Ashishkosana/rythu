...
export const SCHEMES: readonly Scheme[] = [
  ...
  },
  {
    ...
    what_te: "తెలంగాణ ప్రభుత్వం ఇచ్చే పంట పెట్టుబడి సాయం. మొదటి ఎకరానికి ప్రాధాన్యం, దశలవారీగా — ప్రస్తుత మొత్తాన్ని అధికారిక పోర్టల్‌లో చూసుకోండి.",
    what_en: "Telangana's crop investment support (relaunched 2025). First-acre priority, phased — check the current amount on the official portal.",
    who_te: "భూ భారతిలో నమోదైన సాగు భూమి ఉన్న రైతులు. (కౌలుదారులు చాలావరకు అర్హులు కాకపోవచ్చు.)",
    who_en: "Farmers with land recorded in Bhu Bharathi. (Tenant farmers are often not eligible.)",
